...
Dylan and Prajwal worked on the code while Cameron did the write up. We found that doing all the code first and then write up second allowed for a more consistent code and writing style throughout the project.